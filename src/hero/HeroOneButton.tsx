...
const HeroOneButton = (props: IHeroOneButtonProps) => (
  <header className="text-center">
    ...
    <div className="text-2xl pl-4 pr-4 mt-4 mb-8 justify-between">
      I&apos;m a second year graduate student majoring in Computer Science at
      {' '}
      <a
      ...
      , where I work on AI in general and Deep Learning in particular.
    </div>
