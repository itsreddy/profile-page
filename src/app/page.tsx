      ...
      <main className="container mx-auto px-6 py-20 md:py-32 flex flex-col gap-24 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="relative shrink-0 group">
            <div className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-tr from-purple-500 to-blue-500 p-[2px] transition-transform duration-500 group-hover:scale-105">
              <div className="w-full h-full rounded-full bg-[#111] flex items-center justify-center overflow-hidden relative">
                ...
                <span className="text-4xl md:text-6xl font-bold text-gray-700 group-hover:text-white transition-colors">PD</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center md:text-left space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
              <a href="mailto:preddy21196@gmail.com" className="px-8 py-3 rounded-full bg-white text-black font-semibold hover:bg-gray-200 transition-colors active:scale-95">
                Contact Me
              </a>
              <a href="https://prashanthduggirala.app" target="_blank" rel="noopener noreferrer" className="px-8 py-3 rounded-full bg-white/10 border border-white/10 hover:bg-white/20 transition-colors backdrop-blur-md active:scale-95">
                Portfolio
              </a>
            </div>
          </div>
          ...
          <div className="grid gap-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/[0.07] transition-colors">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                <div>
                  <h4 className="text-xl font-semibold text-white">Leoforce Inc.</h4>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/[0.07] transition-colors">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                <div>
                  <h4 className="text-xl font-semibold text-white">University of California, Davis</h4>
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <h4 className="text-lg font-semibold mb-4 text-blue-300">Machine Learning & AI</h4>
              <div className="flex flex-wrap gap-2">
                {["LangChain", "Agents SDK", "DSPy", "LLM", "VLM", "ViT", "MLFlow", "PyTorch", "HuggingFace", "Pandas", "Numpy", "Copilot", "OpenAI", "Bedrock"].map((skill) => (
                  <span key={skill} className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-200 text-sm border border-blue-500/20">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <h4 className="text-lg font-semibold mb-4 text-green-300">Web & DevOps</h4>
              <div className="flex flex-wrap gap-2">
                {["React", "JavaScript", "CSS", "OAuth", "Streamlit", "Appsmith", "Git", "Docker", "Kubernetes", "AWS", "GitLab CICD", "EC2", "OpenSearch", "EKS"].map((skill) => (
                  <span key={skill} className="px-3 py-1 rounded-full bg-green-500/10 text-green-200 text-sm border border-green-500/20">
                    {skill}
                  </span>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="group">
                <h4 className="text-lg font-semibold text-white group-hover:text-pink-400 transition-colors">Text-Prompted Image Segmentation</h4>
              ...
              <div className="group">
                <h4 className="text-lg font-semibold text-white group-hover:text-pink-400 transition-colors">Eye Image Synthesis & Gaze Estimation</h4>
                <p className="text-gray-400 text-sm mt-2">
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-semibold text-white">M.S. Computer Science</h4>
                <p className="text-yellow-500/80">University of California, Davis</p>
                <p className="text-gray-500 text-sm">Sep 2021 • GPA 3.96</p>
              </div>
              <div>
                <h4 className="text-lg font-semibold text-white">B.Tech Computer Engineering</h4>
                <p className="text-yellow-500/80">IIITDM Kancheepuram</p>
        ...
        <section className="space-y-8">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/[0.07] transition-colors">
            <p className="text-gray-300 italic">"Predicting ASD diagnosis in children with synthetic and image-based eye gaze data"</p>
            <p className="text-gray-500 text-sm mt-2">Signal Processing: Image Communication, Volume 94, 2021</p>
            <a href="https://doi.org/10.1016/j.image.2021.116198" target="_blank" rel="noopener noreferrer" className="text-teal-400 text-sm mt-2 inline-block hover:underline">View Publication</a>
          </div>
        </section>
